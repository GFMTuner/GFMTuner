...
from gfmtuner.llm_call.cost_recoder import CostRecorder
import time
...
def call_openai(prompt: str,
    ...
    client = OpenAI()
    print(f"Calling OpenAI model={model}, temperature={temperature}, top_p={top_p}, n={n}, max_tokens={max_tokens}, n_strategy={n_strategy}")
